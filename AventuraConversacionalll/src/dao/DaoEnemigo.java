...
public class DaoEnemigo {
	...
	public Enemigo generarEnemigo(int idEnemigo) throws SQLException {
		...
		while (resultData.next()) {
			...
			e1 = new Enemigo(resultData.getString("nombre"), resultData.getInt("vida_maxima"),
					resultData.getInt("ataque"), resultData.getInt("pocion_vida"), resultData.getInt("pocion_ataque"));
		}
	...
	public ArrayList<Enemigo> generarEnemigos(int idProtagonista) throws SQLException {
		...
		while (resultData.next()) {
			Enemigo e = new Enemigo(resultData.getString("nombre"), resultData.getInt("vida_maxima"),
					resultData.getInt("ataque"), resultData.getInt("pocion_vida"), resultData.getInt("pocion_ataque"));
